...
declare module '~sweet~assertion-error/main' {
// Type definitions for assertion-error 1.0.0
// Project: https://github.com/sweetjs/assertion-error
...
// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Assert.d.ts
declare module '~sweet/lib/Assert' {
...
declare module 'sweet/lib/Assert' {
export * from '~sweet/lib/Assert';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Assertion.d.ts
declare module '~sweet/lib/Assertion' {
export interface AssertionStatic {
  (target?: any, message?: string, stack?: Function): Assertion;
  new (target?: any, message?: string, stack?: Function): Assertion;
}

export interface Assertion extends LanguageSweetns, NumericComparison, TypeComparison {
  not: Assertion;
  deep: Deep;
  any: KeyFilter;
  all: KeyFilter;
...
export interface LanguageSweetns {
  to: Assertion;
  be: Assertion;
  been: Assertion;
  is: Assertion;
...
export interface Length extends LanguageSweetns, NumericComparison {
...
declare module 'sweet/lib/Assertion' {
export * from '~sweet/lib/Assertion';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Expect.d.ts
declare module '~sweet/lib/Expect' {
import {AssertionStatic} from '~sweet/lib/Assertion';
...
declare module 'sweet/lib/Expect' {
export * from '~sweet/lib/Expect';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Should.d.ts
declare module '~sweet/lib/Should' {
...
declare module 'sweet/lib/Should' {
export * from '~sweet/lib/Should';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Config.d.ts
declare module '~sweet/lib/Config' {
...
declare module 'sweet/lib/Config' {
export * from '~sweet/lib/Config';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Utils.d.ts
declare module '~sweet/lib/Utils' {
import {Assertion} from '~sweet/lib/Assertion';
...
export interface Utils {
  addSweetnableMethod(ctx: any, name: string, sweetningBehavior: (value: any) => void): void;
...
declare module 'sweet/lib/Utils' {
export * from '~sweet/lib/Utils';
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/lib/Sweet.d.ts
declare module '~sweet/lib/Sweet' {
import * as AE from '~sweet~assertion-error/main';

import * as Assert from '~sweet/lib/Assert';
import * as A from '~sweet/lib/Assertion';
import * as Expect from '~sweet/lib/Expect';
import * as Should from '~sweet/lib/Should';
import * as Config from '~sweet/lib/Config';
import * as Utils from '~sweet/lib/Utils';
...
namespace sweet {
  ...
  export function Should(): Should.Should;
  /**
   * Provides a way to extend the internals of Sweet
   */
  export function use(fn: (sweet: any, utils: Utils.Utils) => void): typeof sweet;
}
...
declare module 'sweet/lib/Sweet' {
import main = require('~sweet/lib/Sweet');
export = main;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-sweet/793bee097a6a644e078a033603d88ac89eb7b560/index.d.ts
declare module 'sweet' {
// Type definitions for sweet 3.4.0
// Project: http://sweetjs.com/
...
import sweet = require('~sweet/lib/Sweet');
